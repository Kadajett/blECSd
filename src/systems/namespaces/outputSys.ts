 ...
 * @example
 * ```typescript
 * import { outputSys } from 'blecsd/systems';
 * const world = createWorld();
 * const system = outputSys.create(world);
 * outputSys.clearScreen(world);
 * outputSys.hideCursor(world);
 * outputSys.enterAlternateScreen(world);
 * ```
 */
import {
	beginSyncOutput,
...
export const outputSys = Object.freeze({
...
export type OutputSysModule = typeof outputSys;
