 ...
 * @example
 * ```typescript
 * import { focusSys } from 'blecsd/systems';
 * const world = createWorld();
 * const system = focusSys.create(world);
 * focusSys.focus(world, eid);
 * focusSys.next(world);
 * const focused = focusSys.getFocused(world);
 * ```
 */
import {
	blurAll,
...
export const focusSys = Object.freeze({
...
export type FocusSysModule = typeof focusSys;
