...
function canSelectIndex(_world: World, eid: Entity, index: number, itemCount: number): boolean {
...
function fireSelectCallbacks(_world: World, eid: Entity, index: number): void {
	if (index < 0) return;
