 ...
 */
export function hasAnyEffectApplied(world: World, eid: Entity): boolean {
	return (
		hasFocusEffectApplied(world, eid) ||
		hasHoverEffectApplied(world, eid) ||
		hasPressEffectApplied(world, eid) ||
		hasDisabledEffectApplied(world, eid)
	);
}
...
export function getEffectState(
	...
	return {
		focus: hasFocusEffectApplied(world, eid),
		hover: hasHoverEffectApplied(world, eid),
		press: hasPressEffectApplied(world, eid),
		disabled: hasDisabledEffectApplied(world, eid),
	};
}
