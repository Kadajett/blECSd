 ...
 * @example
 * ```typescript
 * import { inputStream } from 'blecsd/terminal';
 *
 * // Create input handler
 * const handler = inputStream.createInputHandler(program, {
 *   enableMouse: true,
 *   enableFocus: true,
 *   enablePaste: true,
 * });
 ...
 * Input stream handler namespace.
 */
export const inputStream = Object.freeze({
	createInputHandler,
});

export type InputStreamModule = typeof inputStream;
