...
import { markDirty, setDimensions, setPosition, setVisible } from 'blecsd/components';
import type { Entity, World } from 'blecsd/core';
import { addComponent, addEntity, removeEntity } from 'blecsd/core';
import { createBackendByType } from '../backends/detection';
import { Camera3D, setCamera3D } from '../components/camera3d';
import { setMaterial3D } from '../components/material';
...
import type { Material3DConfig, Transform3DConfig } from '../schemas/components';
import { type Viewport3DWidgetConfig, Viewport3DWidgetConfigSchema } from '../schemas/viewport3d';
import { framebufferStore } from '../systems/rasterSystem';
